...
Wybrana konfiguracja parametrów powoduje, że ramka UART ma format przedstawiony na rysunku \ref{fig:uart-frame}.
...
Głównym sygnałem zegarowym układu jest \textit{CLK\_16} (rozdz. \ref{clk-16}). Ze względu na jego szybką zmienność przedstawienie go na niektórych przebiegach czasowych nie jest możliwe. W takich przypadkach będzie on zastąpiony umownym sygnałem \textit{CLK\_UART} o częstotliwości $f_{CLK\_UART}$.
\begin{equation*}
